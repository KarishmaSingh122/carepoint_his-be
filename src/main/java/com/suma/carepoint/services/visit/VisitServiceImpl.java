...
public class VisitServiceImpl implements VisitService {
    ...
    public VisitResponse create(VisitRequest request) {
        ...
        log.info("Visit created successfully. visitId={}, patientId={}, doctorId={}, departmentId={}", 
                savedVisit.getVisitId(), patient.getPatientId(), 
                doctor != null ? doctor.getStaffId() 
                        : null, department != null ? department.getDepartmentId() : null);
    ...
    public VisitResponse update(Long visitId, VisitRequest request) {
        ...
        log.info("Visit updated successfully. visitId={}", visitId);
