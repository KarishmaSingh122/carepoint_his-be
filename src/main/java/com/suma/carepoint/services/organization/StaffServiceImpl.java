...
public class StaffServiceImpl implements StaffService {
    ...
    public StaffResponse createStaff(StaffRequest request) {
        ...
        try {
            ...
            log.info("Staff created successfully. staffId={}, employeeNo={}, departmentId={}", savedStaff.getStaffId(), savedStaff.getEmployeeNo(), department.getDepartmentId());
    ...
    public PageResponse getStaff(String search, Boolean active, Long departmentId, int page, int size) {
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.by(Sort.Direction.ASC, "lastName").and(Sort.by(Sort.Direction.ASC, "firstName")));
    ...
    private Staff findStaffById(Long staffId) {
        ...
        return staffRepository.findById(staffId).orElseThrow(() -> new ResourceNotFoundException("Staff not found with id: " + staffId));
    }

    private Department findDepartment(Long departmentId) {

        return departmentRepository.findById(departmentId).orElseThrow(() -> new ResourceNotFoundException("Department not found with id: " + departmentId));
    }
...
//    private PageResponse buildPageResponse(
